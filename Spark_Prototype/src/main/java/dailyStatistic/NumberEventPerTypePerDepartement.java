...
public class NumberEventPerTypePerDepartement {
    ...
    public static void main(String[] args) {
        NumberEventPerTypePerDepartement app = new NumberEventPerTypePerDepartement();
        app.start();
    }
    /**
     * The processing code.
    ...
    public void start() {
        ...
        Dataset<Row> events = spark.read().format("csv").option("header", "true")
                ...
                .filter(col("date_occur_evt").startsWith("2017-01-01"))
